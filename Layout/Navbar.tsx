      ...
      <div className="w-full bg-white border-t-2 border-gray-800 shadow dark:bg-stone-900 dark:border-t-0 dark:border-b-2 dark:border-gray-300/10 ">
        <div className="flex flex-wrap items-center justify-between md:py-2 py-1 px-2 md:px-4 mx-auto text-sm max-w-screen-2xl">
          <div className="flex flex-wrap px-2 md:px-6 lg:pr-8">
            <Link
              className="flex items-center text-black hover:text-gray-600 dark:text-yellow-50 dark:hover:text-lime-200 "
              href="/"
            >
              <Image
                className="inline-block w-10 h-10"
                src="/assets/nftcalendar-logo.png"
                width={15}
                height={15}
                alt="NFT Calendar"
              />
              <span className="block p-1 text-base uppercase md:text-xl pressstart">
                NFTCalendar
              </span>
            </Link>
          </div>
          <div className="flex flex-wrap items-center">
            <div className="hidden md:flex md:flex-wrap items-center">
              <a
                href="https://twitter.com/nftcalendar"
                target="_blank"
                className="dark:text-gray-400 text-gray-500 hover:text-purple-400 border-gray-300 hover:border-purple-400 dark:hover:border-lime-500 dark:border-gray-600 p-0.5 rounded border dark:hover:text-lime-500"
              >
              ...
              <a
                ...
                target="_blank"
                className="mx-1 dark:text-gray-400 text-gray-500 hover:text-purple-400 border-gray-300 hover:border-purple-400 dark:hover:border-lime-500 dark:border-gray-600 p-0.5 rounded border dark:hover:text-lime-500"
              >
...
<path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-1 space-x-2 text-base font-medium leading-6 transition duration-150 ease-in-out border rounded-md group hover:text-gray-600 dark:hover:text-gray-300 dark:focus:text-gray-300 focus:outline-none focus:text-gray-900 text-black border-transparent dark:text-gray-50"
            >
              <svg
                className="w-8 h-8"
                fill="none"
