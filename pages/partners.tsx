...
export default function  Partners(){
    return(
        <>
        <section>
<div className="lg:mt-6 mx-auto container">
<div className="rounded p-6 lg:py-12 md:mx-10 md:p-10 my-8 bg-white dark:bg-zinc-800 dark:border-gray-700">
<h1 className="text-2xl lg:text-3xl font-serif dark:text-yellow-100">We’re Proud to be Partners with</h1>
...
UK Cryptocurrency Media Outlet
</div>
</div>
</div>
</Link>
...
<div className="text-gray-700 dark:text-gray-300 text-lg">
A trusted NFT explorer project
</div>
</div>
</div>
</Link>
...
<div className="text-gray-700 dark:text-gray-300 text-lg">
Mint NFTs with any token on any chain
</div>
</div>
</div>
</Link>
...
<div className="text-gray-700 dark:text-gray-300 text-lg">
Mint, manage, and sell NFT assets without help from developers.
</div>
</div>
</div>
</Link>
