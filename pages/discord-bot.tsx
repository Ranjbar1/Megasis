...
export default function discordBot(){
    return(
        <>
        <main className="flex justify-between lg:flex-row flex-col">
<div className=" w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
<div className="px-4  sm:px-8 xl:pr-16">
<h1 className="text-4xl leading-snug tracking-tight font-extrabold text-gray-900 dark:text-gray-300 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
<span className="block xl:inline">Add value to your Community with</span>
<span className="block text-indigo-600 dark:text-lime-500 xl:inline">our Discord Bot</span>
</h1>
<p className="mt-3  mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 w-full l">
NFT Calendar is the most popular community-driven data source of upcoming NFT drops. You can add our bot to your server to notify your subscribers about the most promising collection launches before they happen.
</p>
